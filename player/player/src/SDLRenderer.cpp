...
bool SDLRenderer::init(void* hwnd)
{
...
int SDLRenderer::loadYuv(int width, int height, const uint8_t* Yplane, int Ypitch,
	...
	SDL_UpdateYUVTexture(m_texture, nullptr, Yplane, Ypitch, Uplane, Upitch, Vplane, Vpitch);
